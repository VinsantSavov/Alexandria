namespace Alexandria.Web.Areas.Identity.Pages.Account
{
    ...
    using static Alexandria.Common.ErrorMessages;
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [EmailAddress]
            [Display(Name = UserEmailDisplayName)]
            ...
            [Display(Name = UserPasswordDisplayName)]
            public string Password { get; set; }

            [DataType(DataType.Password)]
            [Display(Name = UserConfirmPasswordDisplayName)]
            [Compare(nameof(Password), ErrorMessage = UserPasswordsNotMatching)]
